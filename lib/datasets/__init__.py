...
def collate_fn(batch):
    ...
    batch_vid_idx = [b['vid_idx'] for b in batch]
    batch_gt_visual_input = [b['gt_visual_input'] for b in batch]
    ...
    batch_data = {
        ...
        'batch_vid_idx': batch_vid_idx,
        'batch_gt_visual_input': nn.utils.rnn.pad_sequence(batch_gt_visual_input, batch_first=True).float()
    }
